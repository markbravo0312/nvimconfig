...
_G.packer_plugins = {
  ["friendly-snippets.git"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/friendly-snippets.git",
    url = "https://github.com/rafamadriz/friendly-snippets"
  },
  ["galaxyline.nvim"] = {
    config = { "\27LJ\2\0029\0\0\2\0\2\0\0046\0\0\0'\1\1\0B\0\2\1K\0\1\0\30galaxyline.themes.eviline\frequire\0" },
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/galaxyline.nvim",
    url = "https://github.com/NTBBloodbath/galaxyline.nvim"
  },
  ["indent-blankline.nvim.git"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim.git",
    url = "https://github.com/lukas-reineke/indent-blankline.nvim"
  },
  nerdtree = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["tree-sitter.git"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/tree-sitter.git",
